...
v1=list(set(train_df.columns)-set(['building_id','damage_grade','index','label','vdcmun_id','ward_id']))
...
with open('lgb_prob_munc_lvl2_train.pkl', 'wb') as output:
    pickle.dump(pred_train, output)
    
with open('lgb_prob_munc_lvl2_test.pkl', 'wb') as output:
