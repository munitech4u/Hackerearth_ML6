...
v1=list(set(train_df.columns)-set(['building_id','damage_grade','index','label','vdcmun_id','ward_id','g1','g2','g3','g4','g5']))
...
with open('lgb_prob_calibrated_munc.pkl', 'wb') as output:
